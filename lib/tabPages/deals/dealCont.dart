...
class DealCont extends StatefulWidget {
  ItemContainerModule item;
  Function()? refresh;
   DealCont({Key? key, required this.item}) : super(key: key);

  @override
  State<DealCont> createState() => _DealContState();
}

class _DealContState extends State<DealCont> {
  @override
