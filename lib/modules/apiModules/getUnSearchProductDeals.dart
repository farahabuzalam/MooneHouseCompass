...
GetUnSearchProduct getUnSearchProductFromJsonDeals(String str) => GetUnSearchProduct.fromJson(json.decode(str));
...
class Datum {
  ...
  Datum({
    ...
    required this.alias,
    this.services,
    required this.excludeFromPromotion,
    required this.freeDelivery,
    required this.outOfStock,
    required this.buyOneGetOneFree,
